...
import {
  ...
  ScrollDispatcher,
  ViewportRuler
} from "./chunk-GES2PRUW.js";
import "./chunk-QMQVOJF6.js";
import {
  animate,
  state,
  style,
...
var MatDrawer = class _MatDrawer {
  ...
  _animationStarted = new import_rxjs.Subject();
  /** Emits whenever the drawer is done animating. */
  _animationEnd = new import_rxjs.Subject();
  ...
  openedStart = this._animationStarted.pipe((0, import_operators.filter)((e) => e.fromState !== e.toState && e.toState.indexOf("open") === 0), (0, import_operators.mapTo)(void 0));
  /** Event emitted when the drawer has been closed. */
  _closedStream = this.openedChange.pipe((0, import_operators.filter)((o) => !o), (0, import_operators.map)(() => {
  }));
  /** Event emitted when the drawer has started closing. */
  closedStart = this._animationStarted.pipe((0, import_operators.filter)((e) => e.fromState !== e.toState && e.toState === "void"), (0, import_operators.mapTo)(void 0));
   ...
   */
  _modeChanged = new import_rxjs.Subject();
...
var MatDrawerContainer = class _MatDrawerContainer {
  ...
  _doCheckSubject = new import_rxjs.Subject();
  /**
  ...
  _contentMarginChanges = new import_rxjs.Subject();
